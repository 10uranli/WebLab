<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
	response.setHeader("Refresh", "2; URL=loginreg.jsp");
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
	<div class="container text-center">
		<div class="logo-404">
			<a href="index.html"><img src="Bootstrap/images/home/logo.png"
				alt="" /></a>
		</div>
		<div class="content-404">
			<h1>
				<b>OPPS!</b> Yanlış Kullanıcı Bilgisi Girdiniz!
			</h1>
			<p>Soru , görüş ve önerileriniz için : admin@esattim.com</p>
		</div>
	</div>
